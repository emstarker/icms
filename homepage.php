	...
	<div class="home-content">
		<div class="homepage-content">
			<div class="homepage-left">
				<p>অভ্যন্তরীণ সম্পদ বিভাগের মামলার তথ্য ব্যবস্থাপনা সিস্টেমে আপনাকে স্বাগতম।<br>এই সিস্টেমে অভ্যন্তরীণ সম্পদ বিভাগের মামলা সংক্রান্ত তথ্যাদি সংরক্ষণ ও হালনাগাদ করা হয়।</p>
			</div>
			<div class="homepage-right">
				<img id="home-right-image" src="hpr.jpg" alt="হোমপেজ ইমেজ">
			</div>
		</div>
	</div>
	<div class="footer">
