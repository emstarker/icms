...
<head>
    ...
    <title>হোমপেজ । মামলার তথ্য ব্যবস্থাপনা সিস্টেম</title>
...
<body>
	...
	<div class="navigation-bar">
        <ul>
            <li class="active-menu"><a href="homepage.php"><i class="fa fa-house-chimney"></i><br>হোমপেজ</a></li>
            ...
            <li><a href="#"><i class="fa fa-book"></i><br>প্রতিবেদন</a>
                <div class="submenu">
                    <ul>
                        <li><a href="current-status.php">মামলার বর্তমান অবস্থা</a></li>
                        <li><a href="all-reports.php"></a>সকল মামলার তথ্য</li>
                        <li><a href="courtwise-reports.php">আদালতভিত্তিক প্রতিবেদন</a></li>
                        <li><a href="casewise-reports.php">মামলার ধরণভিত্তিক প্রতিবেদন</a></li>                       
                    </ul>
                </div>
            </li>
